"""
ContextChain — Episodic Memory Object (EMO)
The handoff primitive that replaces raw string passing between agents.

v2: adds emo_version, parent_emo_id chain linkage, hallucination guard,
    Ebbinghaus decay weight on evidence, and EMO diff for revisions.
"""
